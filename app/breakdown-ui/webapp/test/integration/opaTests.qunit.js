...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/sparebridge/breakdownui/test/integration/FirstJourney",
    "com/sparebridge/breakdownui/test/integration/BreakdownRequestsListJourney",
    "com/sparebridge/breakdownui/test/integration/BreakdownRequestsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
